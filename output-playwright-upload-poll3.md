- generic [active] [ref=f13e1] [box=0,0,1200,734]:
  - generic [box=0,0,1200,734]:
    - generic [box=450,187,300,360]:
      - generic [box=540,187,120,260]:
        - generic [box=540,187,120,120]:
          - img [box=540,187,120,120]
  ...
  - generic [ref=f13e3] [box=0,0,1200,734]:
    ...
    - generic [ref=f13e22] [box=245,104,904,630]:
      - generic [ref=f13e434] [box=277,-167,840,1858]:
        ...
        - generic [ref=f13e544] [box=277,198,840,278]:
          - heading "App bundles" [level=2] [ref=f13e553] [box=277,206,140,32]
          - alert [ref=f13e805] [box=316,341,737,68]:
            - generic [ref=f13e806] [box=340,366,689,18]:
              - text: You can leave this page while your
              - strong [ref=f13e807] [box=567,366,227,18]: logmaxxing-1.0.0-android-v2.aab
              - text: upload is optimized for distribution.
        - generic [ref=f13e583] [box=277,492,840,626]:
          - heading "Previous release" [level=3] [ref=f13e592] [box=277,504,136,24]
          - generic [ref=f13e593] [box=277,540,840,578]:
            - generic [ref=f13e594] [box=277,540,840,20]: Include app versions from your previous release
            - heading "Included" [level=4] [ref=f13e606] [box=277,582,58,20]
            - generic [ref=f13e613] [box=505,732,360,72]:
              - img [ref=f13e617] [box=673,732,24,24]: slow_motion_video
              - paragraph [ref=f13e619] [box=505,764,360,40]: No app bundles from your previous release will be included in this release
            - generic [ref=f13e625] [box=277,920,816,68]:
              - heading "Not Included" [level=4] [ref=f13e631] [box=277,934,86,20]
              - generic [ref=f13e633] [box=277,968,816,20]: These versions from your previous release won't be included in this release
            - grid "Artifacts" [ref=f13e643] [box=277,1004,816,114]:
              - row "File type Version API levels Target SDK Screen layouts ABIs Required features" [ref=f13e644] [box=277,1004,816,57]:
                - columnheader "File type" [ref=f13e645] [cursor=pointer] [box=277,1004,95,56]
                - columnheader "Version" [ref=f13e646] [cursor=pointer] [box=372,1004,95,56]
                - columnheader "API levels" [ref=f13e647] [cursor=pointer] [box=467,1004,95,56]
                - columnheader "Target SDK" [ref=f13e648] [cursor=pointer] [box=562,1004,95,56]
                - columnheader "Screen layouts" [ref=f13e649] [cursor=pointer] [box=657,1004,95,56]
                - columnheader "ABIs" [ref=f13e650] [cursor=pointer] [box=752,1004,95,56]
                - columnheader "Required features" [ref=f13e651] [cursor=pointer] [box=847,1004,95,56]
                - cell [ref=f13e652] [box=942,1004,95,56]
                - cell [ref=f13e653] [box=1037,1004,56,56]
              - 'row "Table cell with a popup 1 (1.0.0) 24+ 36 4 4 2 Include View details for App bundle: 1 (1.0.0)" [ref=f13e654] [box=277,1061,816,57]':
                - gridcell "Table cell with a popup" [ref=f13e655] [box=277,1061,95,56]
                - gridcell "1 (1.0.0)" [ref=f13e665] [box=372,1061,95,56]
                - gridcell "24+" [ref=f13e667] [box=467,1061,95,56]
                - gridcell "36" [ref=f13e669] [box=562,1061,95,56]
                - gridcell "4" [ref=f13e671] [box=657,1061,95,56]
                - gridcell "4" [ref=f13e673] [box=752,1061,95,56]
                - gridcell "2" [ref=f13e675] [box=847,1061,95,56]
                - gridcell "Include" [ref=f13e677] [box=942,1061,95,56]
                - 'gridcell "View details for App bundle: 1 (1.0.0)" [ref=f13e684] [box=1037,1061,56,56]'
        - generic [ref=f13e691] [box=277,1134,840,557]:
          - heading "Release details" [level=2] [ref=f13e700] [box=277,1142,165,32]
          - generic [ref=f13e704] [box=277,1182,840,509]:
            - generic [ref=f13e705] [box=277,1198,816,493]:
              - group "Release name" [ref=f13e707] [box=277,1198,816,136]:
                - generic [ref=f13e710] [box=277,1211,245,20]: Release name *
                - generic [ref=f13e712] [box=546,1198,547,112]
              - group "Release notes" [ref=f13e723] [box=277,1334,816,357]:
                - generic [ref=f13e726] [box=277,1347,245,20]: Release notes
                - generic [ref=f13e728] [box=546,1334,547,317]
      ...
      - generic [ref=f13e30] [box=245,1883,904,56]:
        - generic [ref=f13e441] [box=534,1883,324,20]:
          - link "Product updates" [ref=f13e442] [cursor=pointer] [box=534,1883,111,20]:
            - /url: https://play.google.com/console/about/whats-new/
          - link "Status dashboard" [ref=f13e443] [cursor=pointer] [box=678,1883,118,20]:
            - /url: https://status.play.google.com/
          - link "Help" [ref=f13e444] [cursor=pointer] [box=828,1883,31,20]:
            - /url: /console/u/0/developers/5287518962627182225/help-and-support?app=4973787382234880432
        - generic [ref=f13e445] [box=424,1919,545,20]:
          - generic [ref=f13e446] [box=424,1919,96,20]: © 2026 Google
          - link "Privacy" [ref=f13e447] [cursor=pointer] [box=544,1919,47,20]:
            - /url: https://www.google.com/policies/privacy/
          - link "Developer Distribution Agreement" [ref=f13e448] [cursor=pointer] [box=615,1919,222,20]:
            - /url: https://play.google.com/about/developer-distribution-agreement.html
          - link "Terms of Service" [ref=f13e449] [cursor=pointer] [box=861,1919,109,20]:
